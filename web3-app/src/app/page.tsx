    ...
    <div className="min-h-screen relative text-stone-900 font-serif bg-[#F5F2EB] overflow-x-hidden flex flex-col">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden h-full pointer-events-none">
        {[...Array(20)].map((_, i) => {
          ...
          const randomSize = 28 + Math.random() * 32; 
          ...
          return (
            ...
            >
              {isFeather ? 
                ...
                <Leaf size={randomSize} strokeWidth={1.5} fill={color} fillOpacity={0.1} />
              }
            </motion.div>
          )
        })}
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 h-24 flex items-center justify-between">
          ...
          <button onClick={() => setMobileMenuOpen(true)} className="lg:hidden p-3 text-stone-900 bg-white border border-[#E5E0D6] rounded-xl shadow-sm hover:bg-[#E5E0D6] transition-colors">
